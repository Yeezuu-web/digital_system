          ...
          <table cellspacing="0" cellpadding="0" border="0" align="center"
            ...
            <tr style="border-collapse:collapse">
              <td cellpadding="0" cellspacing="0" border="0" style="padding:0;Margin:0;line-height:1px;min-width:600px"
                height="0"><img
                  src="https://kbcjgs.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
      ...
      <tr style="border-collapse:collapse">
        <td valign="top" style="padding:0;Margin:0">
          <table cellpadding="0" cellspacing="0" class="es-content" align="center"
            ...
            <tr style="border-collapse:collapse">
              <td style="padding:0;Margin:0;background-color:#fe4f4a" bgcolor="#fe4f4a" align="center">
                        ...
                        <tr style="border-collapse:collapse">
                          <td valign="top" align="center" style="padding:0;Margin:0;width:600px">
                            <table
                              ...
                              width="100%" bgcolor="#ffffff" cellspacing="0" cellpadding="0" role="presentation">
                              <tr style="border-collapse:collapse">
                                <td align="center"
                                  style="Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px">
                                  <h1
                                    style="Margin:0;line-height:46px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:38px;font-style:normal;font-weight:normal;color:#111111">
                                    FB Boosting Request</h1>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse">
                              ...
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                  style="Margin:0;padding-top:20px;padding-bottom:20px;padding-left:30px;padding-right:30px">
                                    ...
                                    received Facebook Boosting Request from {{ $details['requester_name'] }} for Client {{ $details['company'] }}/ Program {{ $details['brand'] }} for an amount of USD {{ $details['budget'] }}.    
                                    <br>The reason for this request is: {{ $details['detail'] }} <br>   
                                    @if ($details['action'] != 'review')
                                    This request already reviewed by {{ $details['review_by'] }}  
                                    @endif
                                    Please click the link below for detailed information and {{ $details['action'] }}:</p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td align="center"
                                  style="Margin:0;padding-left:10px;padding-right:10px;padding-top:35px;padding-bottom:35px">
                                    <span class="es-button-border"
                                        style="border-style:solid;border-color:#FFA73B;background:#fe4f4a;border-width:1px;display:inline-block;border-radius:2px;width:auto">
                                        <a
                                          href="{{ $details['link'] }}" class="es-button es-button-1" target="_blank"
                                          style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-color:#fe4f4a;border-width:15px 30px;display:inline-block;background:#fe4f4a;border-radius:2px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center">
                                          {{ $details['btn'] }}
                                        </a>
                                    </span>
                                </td>
