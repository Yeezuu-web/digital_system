                              ...
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                  style="Margin:0;padding-top:20px;padding-bottom:20px;padding-left:30px;padding-right:30px">
                                    ...
                                    <p>You received Employee Leave Request from {{ $details['employee'] }}. This leave is on {{ $details['commencement_date'] }} to {{ $details['resumption_date'] }}.</p> 
                                   
                                    <p>The reason for this request is: {{ $details['reason'] }}</p>
                                    <p>Please click the link below for detailed information and approve:</p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td align="center"
