...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.boost.title_singular') }} Request For Approval
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-12 mt-3">
                ...
                @elseif($boost->status == '2' || $boost->status == '3')
                    <button type="button" class="btn btn-secondary float-lg-right" disabled>
                        Approved
                    </button>
                @endif
...
<script>
    ...
    approve = (id, action) => {
        ...
        $.ajax({
            type: "POST",
            url: "/system/admin/boosts/secondApprove/update/" + id,
            data: {
                _token: _token,
                action: action,
                id: id
