...
<div class="row w-100 mx-0 auth-page">
    <div class="col-md-10 col-xl-10 mx-auto">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.boosts.request.store') }}" method="POST" id="my-form" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="boost_start">Start Boost from <small class="text-danger">*</small></label>
                                <input type="date" name="boost_start" class="form-control" id="boost_start"/>
                            </div>
                            <div class="form-group">
                                <label for="boost_end">End Boost on <small class="text-danger">*</small></label>
                                <input type="date" name="boost_end" class="form-control" id="boost_end"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="reason">Reson for boosting <small class="text-danger">*</small></label>
                        ...
                        <div class="col-md-3 mx-auto d-flex justify-content-center">
                            ...
                            <a href="/system/admin" class="btn btn-secondary btn-lg ml-2">Back</a>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    url: '{{ route('admin.boosts.storeMedia') }}',
    maxFilesize: 10, // MB
