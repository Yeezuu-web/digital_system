...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.holidays.update', [$holiday->id]) }}" method="POST" autocomplete="off">
            @method('PUT')
            @csrf
            <div class="form-group">
                <input class="form-control @error('title') form-control-danger @enderror" type="text" name="title" id="title"  value="{{ old('title', $holiday->title) }}" required>
                @error('title')
            ...
            <div class="form-group">
                ...
                <input class="form-control yearpicker @error('year') form-control-danger @enderror" type="text" name="year" id="year" value="{{ old('year', $holiday->year) }}" required>
                @error('year')
